/**
 * InnerLedStrip.h - Animates the UFO Outer LED Strip  
 * Created by Tony Gaitatzis, 2018
 * Released into the public domain.
 */
 
#ifndef InnerLedStrip_h
#define InnerLedStrip_h
...
class InnerLedStrip {
  public:
    ...
    // constructors
    InnerLedStrip(const unsigned int ledPin, const unsigned int numLeds);
    ~InnerLedStrip();
