 ...
 */
const unsigned int NEOPIXEL_WIDTH = 30; //30; // 8
const unsigned int NEOPIXEL_HEIGHT = 10; //10; // 8
 ...
 */
//const unsigned int animationFrameTimeout_ms = 250;
...
WaterfallPlotter waterfallPlotter = WaterfallPlotter(NEOPIXEL_WIDTH, NEOPIXEL_HEIGHT, NEOPIXEL_PIN, redg_10_30_bits); 
