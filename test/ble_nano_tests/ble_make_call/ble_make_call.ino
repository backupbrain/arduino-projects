...
GattCharacteristic  characteristic2(service1_rx_uuid, (uint8_t*) rx_value, 1, TXRX_BUF_LEN, GattCharacteristic::BLE_GATT_CHAR_PROPERTIES_NOTIFY | GattCharacteristic::BLE_GATT_CHAR_PROPERTIES_READ);
...
void setup() {
    ...
    ble.accumulateAdvertisingPayload(GapAdvertisingData::SHORTENED_LOCAL_NAME,
                                     (const uint8_t *)"MyDevice", sizeof("MyDevice") - 1);
    ...
    // set device name
    ble.setDeviceName((const uint8_t *)"MyDevice");
...
//          ble.updateCharacteristicValue(characteristic2.getValueAttribute().getHandle(), rx_value, rx_buf_num);
          ble.updateCharacteristicValue(characteristic2.getValueAttribute().getHandle(), (uint8_t*) rx_value, TXRX_BUF_LEN);
          sendData = false;
        }
