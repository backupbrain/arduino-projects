...
const char* mqtt_server = "app.tonygaitatzis.com";
const int mqtt_port = 8883;


const char* mqtt_in_topic = "test/in";
const char* mqtt_out_topic = "test/out";
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect("ESP8266Client")) {
      ...
      client.publish(mqtt_in_topic, "hello world");
      // ... and resubscribe
...
void loop() {
  ...
  if (now - lastMsg > 2000) {
    ...
    Serial.println(msg);
    client.publish(mqtt_in_topic, msg);
  }
}
